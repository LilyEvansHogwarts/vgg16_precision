...
def build_network(height = h, width = w, channel = c):
    ...
    conv1_1_W = tf.get_variable(name='conv1_1_W',initializer=weights['conv1_1_W'],dtype=tf.float32)
    conv1_2_W = tf.get_variable(name='conv1_2_W',initializer=weights['conv1_2_W'],dtype=tf.float32)
    conv2_1_W = tf.get_variable(name='conv2_1_W',initializer=weights['conv2_1_W'],dtype=tf.float32)
    conv2_2_W = tf.get_variable(name='conv2_2_W',initializer=weights['conv2_2_W'],dtype=tf.float32)
    conv3_1_W = tf.get_variable(name='conv3_1_W',initializer=weights['conv3_1_W'],dtype=tf.float32)
    conv3_2_W = tf.get_variable(name='conv3_2_W',initializer=weights['conv3_2_W'],dtype=tf.float32)
    conv3_3_W = tf.get_variable(name='conv3_3_W',initializer=weights['conv3_3_W'],dtype=tf.float32)
    conv4_1_W = tf.get_variable(name='conv4_1_W',initializer=weights['conv4_1_W'],dtype=tf.float32)
    conv4_2_W = tf.get_variable(name='conv4_2_W',initializer=weights['conv4_2_W'],dtype=tf.float32)
    conv4_3_W = tf.get_variable(name='conv4_3_W',initializer=weights['conv4_3_W'],dtype=tf.float32)
    conv5_1_W = tf.get_variable(name='conv5_1_W',initializer=weights['conv5_1_W'],dtype=tf.float32)
    conv5_2_W = tf.get_variable(name='conv5_2_W',initializer=weights['conv5_2_W'],dtype=tf.float32)
    conv5_3_W = tf.get_variable(name='conv5_3_W',initializer=weights['conv5_3_W'],dtype=tf.float32)

    conv1_1_b = tf.get_variable(name='conv1_1_b',initializer=weights['conv1_1_b'],dtype=tf.float32)
    conv1_2_b = tf.get_variable(name='conv1_2_b',initializer=weights['conv1_2_b'],dtype=tf.float32)
    conv2_1_b = tf.get_variable(name='conv2_1_b',initializer=weights['conv2_1_b'],dtype=tf.float32)
    conv2_2_b = tf.get_variable(name='conv2_2_b',initializer=weights['conv2_2_b'],dtype=tf.float32)
    conv3_1_b = tf.get_variable(name='conv3_1_b',initializer=weights['conv3_1_b'],dtype=tf.float32)
    conv3_2_b = tf.get_variable(name='conv3_2_b',initializer=weights['conv3_2_b'],dtype=tf.float32)
    conv3_3_b = tf.get_variable(name='conv3_3_b',initializer=weights['conv3_3_b'],dtype=tf.float32)
    conv4_1_b = tf.get_variable(name='conv4_1_b',initializer=weights['conv4_1_b'],dtype=tf.float32)
    conv4_2_b = tf.get_variable(name='conv4_2_b',initializer=weights['conv4_2_b'],dtype=tf.float32)
    conv4_3_b = tf.get_variable(name='conv4_3_b',initializer=weights['conv4_3_b'],dtype=tf.float32)
    conv5_1_b = tf.get_variable(name='conv5_1_b',initializer=weights['conv5_1_b'],dtype=tf.float32)
    conv5_2_b = tf.get_variable(name='conv5_2_b',initializer=weights['conv5_2_b'],dtype=tf.float32)
    conv5_3_b = tf.get_variable(name='conv5_3_b',initializer=weights['conv5_3_b'],dtype=tf.float32)

    fc6_W = tf.get_variable(name='fc6_W',initializer=weights['fc6_W'],dtype=tf.float32)
    fc7_W = tf.get_variable(name='fc7_W',initializer=weights['fc7_W'],dtype=tf.float32)
    fc8_W = tf.get_variable(name='fc8_W',initializer=weights['fc8_W'],dtype=tf.float32)

    fc6_b = tf.get_variable(name='fc6_b',initializer=weights['fc6_b'],dtype=tf.float32)
    fc7_b = tf.get_variable(name='fc7_b',initializer=weights['fc7_b'],dtype=tf.float32)
    fc8_b = tf.get_variable(name='fc8_b',initializer=weights['fc8_b'],dtype=tf.float32)
...
#    prediction_labels = tf.argmax(finaloutput, axis=1, name='output')
    ...
    with tf.Session() as sess:
        ...
        sess.run(init)
        constant_graph = graph_util.convert_variables_to_constants(sess, tf.get_default_graph().as_graph_def(), ["softmax"])
