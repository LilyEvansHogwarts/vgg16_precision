...
def build_network(height = h, width = w, channel = c):
    ...
    conv1_1_W = tf.Variable(name='conv1_1_W',initial_value=weights['conv1_1_W'],dtype=tf.float32)
    conv1_2_W = tf.Variable(name='conv1_2_W',initial_value=weights['conv1_2_W'],dtype=tf.float32)
    conv2_1_W = tf.Variable(name='conv2_1_W',initial_value=weights['conv2_1_W'],dtype=tf.float32)
    conv2_2_W = tf.Variable(name='conv2_2_W',initial_value=weights['conv2_2_W'],dtype=tf.float32)
    conv3_1_W = tf.Variable(name='conv3_1_W',initial_value=weights['conv3_1_W'],dtype=tf.float32)
    conv3_2_W = tf.Variable(name='conv3_2_W',initial_value=weights['conv3_2_W'],dtype=tf.float32)
    conv3_3_W = tf.Variable(name='conv3_3_W',initial_value=weights['conv3_3_W'],dtype=tf.float32)
    conv4_1_W = tf.Variable(name='conv4_1_W',initial_value=weights['conv4_1_W'],dtype=tf.float32)
    conv4_2_W = tf.Variable(name='conv4_2_W',initial_value=weights['conv4_2_W'],dtype=tf.float32)
    conv4_3_W = tf.Variable(name='conv4_3_W',initial_value=weights['conv4_3_W'],dtype=tf.float32)
    conv5_1_W = tf.Variable(name='conv5_1_W',initial_value=weights['conv5_1_W'],dtype=tf.float32)
    conv5_2_W = tf.Variable(name='conv5_2_W',initial_value=weights['conv5_2_W'],dtype=tf.float32)
    conv5_3_W = tf.Variable(name='conv5_3_W',initial_value=weights['conv5_3_W'],dtype=tf.float32)

    conv1_1_b = tf.Variable(name='conv1_1_b',initial_value=weights['conv1_1_b'],dtype=tf.float32)
    conv1_2_b = tf.Variable(name='conv1_2_b',initial_value=weights['conv1_2_b'],dtype=tf.float32)
    conv2_1_b = tf.Variable(name='conv2_1_b',initial_value=weights['conv2_1_b'],dtype=tf.float32)
    conv2_2_b = tf.Variable(name='conv2_2_b',initial_value=weights['conv2_2_b'],dtype=tf.float32)
    conv3_1_b = tf.Variable(name='conv3_1_b',initial_value=weights['conv3_1_b'],dtype=tf.float32)
    conv3_2_b = tf.Variable(name='conv3_2_b',initial_value=weights['conv3_2_b'],dtype=tf.float32)
    conv3_3_b = tf.Variable(name='conv3_3_b',initial_value=weights['conv3_3_b'],dtype=tf.float32)
    conv4_1_b = tf.Variable(name='conv4_1_b',initial_value=weights['conv4_1_b'],dtype=tf.float32)
    conv4_2_b = tf.Variable(name='conv4_2_b',initial_value=weights['conv4_2_b'],dtype=tf.float32)
    conv4_3_b = tf.Variable(name='conv4_3_b',initial_value=weights['conv4_3_b'],dtype=tf.float32)
    conv5_1_b = tf.Variable(name='conv5_1_b',initial_value=weights['conv5_1_b'],dtype=tf.float32)
    conv5_2_b = tf.Variable(name='conv5_2_b',initial_value=weights['conv5_2_b'],dtype=tf.float32)
    conv5_3_b = tf.Variable(name='conv5_3_b',initial_value=weights['conv5_3_b'],dtype=tf.float32)

    fc6_W = tf.Variable(name='fc6_W',initial_value=weights['fc6_W'],dtype=tf.float32)
    fc7_W = tf.Variable(name='fc7_W',initial_value=weights['fc7_W'],dtype=tf.float32)
    fc8_W = tf.Variable(name='fc8_W',initial_value=weights['fc8_W'],dtype=tf.float32)

    fc6_b = tf.Variable(name='fc6_b',initial_value=weights['fc6_b'],dtype=tf.float32)
    fc7_b = tf.Variable(name='fc7_b',initial_value=weights['fc7_b'],dtype=tf.float32)
    fc8_b = tf.Variable(name='fc8_b',initial_value=weights['fc8_b'],dtype=tf.float32)
